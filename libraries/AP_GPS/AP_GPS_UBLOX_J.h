...
// u-Blox UBX driver for Jamming and Spoofing detection
// To be used with AP_Periph...
// By EOSBandi 2023
// 
//  Based on :
//
...
#define UBLOX_MAX_VISIBLE_SATS 64
...
#define CONFIG_ITFM          (1<<20)
#define CONFIG_RATE_SAT      (1<<21)
...
class AP_GPS_UBLOX_J : public AP_GPS_Backend
{
public:
    AP_GPS_UBLOX_J(AP_GPS &_gps, AP_GPS::GPS_State &_state, AP_HAL::UARTDriver *_port, AP_GPS::GPS_Role role);
    ~AP_GPS_UBLOX_J() override;
