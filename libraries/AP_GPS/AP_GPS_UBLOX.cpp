...
/*
  GNSS integrity: jamming/interference monitor and UBX-SEC-SIG output.
  Applied via _configure_config_set(), so a receiver without the key
  NACKs and the config bit is cleared
 */
const AP_GPS_UBLOX::config_list AP_GPS_UBLOX::config_ITFM[] {
    {ConfigKey::CFG_ITFM_ENABLE, 1},
};

const AP_GPS_UBLOX::config_list AP_GPS_UBLOX::config_SEC_SIG_uart1[] {
    {ConfigKey::MSGOUT_UBX_SEC_SIG_UART1, RATE_HW},
};

const AP_GPS_UBLOX::config_list AP_GPS_UBLOX::config_SEC_SIG_uart2[] {
    {ConfigKey::MSGOUT_UBX_SEC_SIG_UART2, RATE_HW},
};
