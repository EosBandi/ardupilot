...
private:
    ...
    enum class ConfigKey : uint32_t {
        ...
        // GNSS integrity: jamming/interference monitor enable and
        // UBX-SEC-SIG output rate
        CFG_ITFM_ENABLE                 = 0x1041000d,
        MSGOUT_UBX_SEC_SIG_UART1        = 0x20910635,
        MSGOUT_UBX_SEC_SIG_UART2        = 0x20910636,
    ...
    bool _have_sec_sig;
    // receivers configured through CFG-VALSET keys on the legacy path
    ...
    static const config_list config_SEC_SIG_uart1[];
    static const config_list config_SEC_SIG_uart2[];
