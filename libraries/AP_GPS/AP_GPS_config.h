...
#ifndef AP_GPS_GNSS_INTEGRITY_SENDING_ENABLED
#define AP_GPS_GNSS_INTEGRITY_SENDING_ENABLED HAL_GCS_ENABLED && AP_GPS_ENABLED
#endif

// receive GNSS integrity state (ardupilot.gnss.Integrity) from DroneCAN GPS nodes
#ifndef AP_GPS_DRONECAN_INTEGRITY_ENABLED
#define AP_GPS_DRONECAN_INTEGRITY_ENABLED AP_GPS_DRONECAN_ENABLED
#endif
