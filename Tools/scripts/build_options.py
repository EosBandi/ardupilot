...
BUILD_OPTIONS = [
    ...
    Feature('MAVLink', 'GNSS_INTEGRITY_SENDING', 'AP_GPS_GNSS_INTEGRITY_SENDING_ENABLED', 'Enable sending of GNSS_INTEGRITY mavlink message', 0, None),  # noqa
    ...
    Feature('GPS Drivers', 'DRONECAN_GPS_INTEGRITY', 'AP_GPS_DRONECAN_INTEGRITY_ENABLED', 'Enable receiving GNSS integrity state from DroneCAN GPS', 0, 'DroneCAN'),  # noqa
